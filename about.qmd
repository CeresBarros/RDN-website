...
One important feature of system that determines its resilience is the variation in how their individual components respond to perturbations. This variation in responses is known as response diversity. It is implicated in the resilience of many kinds of systems to perturbations, including food production systems, financial systems, ecosystems, health systems, communications system, to name but a few ([e.g. Walker et al 2023](https://www.nature.com/articles/s41893-022-01048-7){target="_blank"}).
