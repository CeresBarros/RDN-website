...
The founders of the network were mostly ecologists, and although they had broad interests, the network's perspective on response diversity research was rather ecologically dominated. Inspired by the paper [Response diversity as a sustainability strategy, by Brian Walker et al., published in early 2023)](https://www.nature.com/articles/s41893-022-01048-7) the network has taken steps to expand its scope. It now has numerous authors of that paper as members, and has revised its web pages. ***How to get involved***: We still have work to do in representation of the diversity of response diversity research. You can help by point out what we might have missed (to Owen or Sam, for example).
